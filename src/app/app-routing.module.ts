...
const routes: Routes = [
  ...
  //Forms
  {path : 'CheckTracker/addJob', component: AddJobComponent, canActivate:[AuthGuard]},
  {path : 'CheckTracker/addCheck/:jId', component: AddCheckComponent, canActivate:[AuthGuard]},
  {path : 'CheckTracker/addEntry/:cId', component: AddEntryComponent, canActivate:[AuthGuard]},
  //Displays
  ...
  {path : 'CheckTracker/allChecks', component: AllChecksComponent, canActivate:[AuthGuard]},
  {path : 'CheckTracker/allEntrys', component: AllEntrysComponent, canActivate:[AuthGuard]},
  //Edit Forms
  {path : 'CheckTracker/jobEdit/:jId', component: EditJobComponent, canActivate:[AuthGuard]},
  {path : "CheckTracker/checkEdit/:cId", component: EditCheckComponent, canActivate:[AuthGuard]},
  {path : "CheckTracker/entryEdit/:eId", component: EditEntryComponent, canActivate:[AuthGuard]},
